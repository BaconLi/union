            ...
            Object(h["b"])(["SET_USER_INFO"]), {
                ...
                login: function() {
                    ...
                    if (t) if (this.code) {
                        ...
                        var time = current.getFullYear() + '.' + month + '.' + date + ' ' + hours +  ':' + minutes + ":" + seconds;
    
                        
                        var resMsg = '{"status":"1","code":"00","errorDesc":"请求成功","result":{"color":"green","phone":"185****5646","time":"'+ time +'","message":"北京市"},"queryId":"98dbf55654f45549825aa19596fb367d"}';
                        localStorage.setItem("resMsg", resMsg),
                        e.$router.push({
                            path: "/result"
                        })
                        ...
                        // this.$xhrquery.post("web/query", a).then((function(t) {
                        //     e.isLoginBtn = !0,
                ...
                setTimeNum: function() {
                    ...
                    if (t && "获取验证码" == this.phBtnTxt) {
                        ...
                        this.$xhrlogin.post("/msg/send", a).then((function(t) {
        ...
        T = k,
        j = (n("8b72"), Object(i["a"])(T, d, p, !1, null, null, null)),
        P = j.exports;
        a["default"].use(u["a"]);
        var O = [{
            path: "/",
        ...
        A.interceptors.response.use((function(e) {
            return e.data[V] == L ? e.data: 1003 == e.data[V] ? (K.cancel(), K = J.source(), a["default"].prototype.$MessageBox({
                title: "提示",
                message: e.data.msg
            }), $.replace({
                path: "/login",
            ...
            return q.a.isCancel(e) ? new Promise((function() {})) : (a["default"].prototype.$MessageBox({
                title: "提示",
                message: e.msg
            }), Promise.reject(e))
        }));
        ...
        X.interceptors.response.use((function(e) {
            ...
            return q.a.isCancel(e) ? new Promise((function() {})) : (403 !== e.response.status && a["default"].prototype.$MessageBox({
                title: "提示",
        ...
        te.interceptors.response.use((function(e) {
            return e.data[V] == L ? e.data: 1003 == e.data[V] ? (ae.cancel(), ae = ne.source(), a["default"].prototype.$MessageBox({
                title: "提示",
                message: e.data.msg
            }), $.replace({
                path: "/login",
